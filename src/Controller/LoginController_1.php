            ...
            if ($this->User->validates()) {
                ...
                if (isset($this->request->data['User']['terms']) && ($this->request->data['User']['terms'] == "on")) {
                    ...
                    if ($this->User->save($this->request->data)) {
                        ...
                        $messageToUser = "Thanks,you are successfully subscribed for  with Reverse Advisor,confirm your registraion by clicking below.";
                        $Email = new CakeEmail();
                        ...
                        $Email->subject('Reverse Advisor:Registraion Confirmation');
                        $Email->send();
    ...
    public function ajax_forgot_password() {
        ...
        if ($this->request->is('post')) {
            ...
            if ($this->User->validates()) {
                ...
                $record = $this->User->find('first', array('conditions' => $conditions, 'fields' => array('User.id', 'User.email', 'User.token', 'User.username')));
                if (isset($record) && (empty($record))) {
                    ...
                    $messageToUser = "We just got your request to forgot password,if you did that,please click on the link below to set the new password.";
                    $Email = new CakeEmail();
                    ...
                    $Email->emailFormat('html');
                    $Email->viewVars(array('userName' => $record['User']['username'], 'usertoken' => $record['User']['token'], 'messageToUser' => $messageToUser));
                    $Email->subject('Reverse Advisor:Forgot Password');
                    $Email->send();
