 ...
 * @var string
 */
define('SECRET_ACCESS_TOKEN', 'addfjgkdfljgnsdgjsidbsfjsdfjsdigbsdijsdoidnsgda');
 ...
 * @var string
 */
//https://github.com/sonusindhu/revadv.git
define('REMOTE_REPOSITORY', 'git@github.com:sonusindhu/revadv.git');
...
define('TARGET_DIR', '/var/www/clients/client1/web58/web/developer/');
