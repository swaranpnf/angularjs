 ...
 * @var string
 */
define('SECRET_ACCESS_TOKEN', 'test12344444444444nkvbkdsjj');
...
define('REMOTE_REPOSITORY', 'github.com/swaranpnf/angularjs.git');
...
define('TARGET_DIR', '/opt/lampp/htdocs/angular/my_app_name/');
